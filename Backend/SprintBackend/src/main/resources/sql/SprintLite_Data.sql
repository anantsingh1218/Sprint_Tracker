...
INSERT INTO Sprint (sprintName, sprintDuration, status, startDate, endDate)
VALUES
  ('Sprint 1', 15, 'ACTIVE', '2026-06-01', '2026-06-15'),
  ( 'Sprint 2', 15, 'PLANNED', '2026-06-16', '2026-06-30');
INSERT INTO Users (username, role, email, passwordHash, createdAt, createdBy, updatedAt, updatedBy)
VALUES
  ('Alice', 'ROLE_Product Manager', 'alice@gmail.com', '12345hsnmo39@19xhq][23', NULL, NULL, NULL, NULL),
      ( 'Bob', 'ROLE_Developer','bob@gmail.com', '1234hsnmo39@19xhq][23|', NULL, NULL, NULL, NULL),
  ( 'Charlie', 'ROLE_Scrum Master','charlie@gmail.com', '1245hsnmo39@19xhq][23\', NULL, NULL, NULL, NULL);
INSERT INTO ProductTable (productName, description, ownerId, createdAt, createdBy, updatedAt, updatedBy)
VALUES
  ('FSM', 'Field Service Management', 1, NULL, NULL, NULL, NULL),
  ( 'Starwatch', 'Analytics Platform', 1, NULL, NULL, NULL, NULL);
...
VALUES
  ( 'Lead Management', 'Manage customer leads', 1, 1, 'IN_PROGRESS', 'HIGH', 8, 3, NULL, NULL, NULL, NULL),
  ( 'Business Dashboards', 'Analytics dashboards', 2, 2, 'OPEN', 'MEDIUM', 13, 13, NULL, NULL, NULL, NULL);
...
VALUES
  ( 'Lead Creation', 'As a sales rep I can create leads', 1, 2, 'IN_PROGRESS', 'HIGH', 1, 5, NULL, NULL, NULL, NULL),
  ( 'Lead Search', 'As a sales rep I can search leads', 1, 2, 'OPEN', 'MEDIUM', 1, 3, NULL, NULL, NULL, NULL),
  ( 'Dashboard Creation', 'As a manager I can create dashboards', 2, 2, 'OPEN', 'HIGH', 2, 8, NULL, NULL, NULL, NULL);
...
VALUES
  ( 'Gather Requirements', 'Collect lead requirements', 2, 'DONE', 'MEDIUM', 1, 1, 4, 0, NULL, NULL, NULL, NULL),
  ( 'Design Lead Screen', 'Create lead UI', 2, 'IN_PROGRESS', 'HIGH', 1, 1, 8, 3, NULL, NULL, NULL, NULL),
  ( 'Implement Lead API', 'Create backend APIs', 2, 'OPEN', 'HIGH', 1, 1, 12, 12, NULL, NULL, NULL, NULL),
  ('Dashboard Wireframe', 'Create dashboard wireframe', 2, 'OPEN', 'MEDIUM', 3, 2, 6, 6, NULL, NULL, NULL, NULL);
...
VALUES
  ( 'OPEN', 'CRITICAL', 'Lead page crashes on save', 2, 1, 1, 6, 6, NULL, NULL, NULL, NULL),
  ( 'IN_PROGRESS', 'HIGH', 'Duplicate lead creation issue', 2, 1, 1, 8, 3, NULL, NULL, NULL, NULL),
  ( 'OPEN', 'MEDIUM', 'Dashboard timeout issue', 2, 3, 2, 10, 10, NULL, NULL, NULL, NULL);
INSERT INTO Attachments ( fileName, filePath, uploadedBy, createdAt, createdBy, updatedAt, updatedBy)
VALUES
  ( 'lead-error.png', 'uploadslead-error.png', 2, NULL, NULL, NULL, NULL),
  ( 'dashboard-wireframe.pdf', 'uploadsdashboard-wireframe.pdf', 2, NULL, NULL, NULL, NULL);
...
VALUES
  ( 'Need API validation before release', 'STORY', 1, 'Alice', NULL, 'Alice', NULL),
  ( 'Crash reproducible in QA environment', 'BUG', 1, 'Charlie', NULL, 'Charlie', NULL);
