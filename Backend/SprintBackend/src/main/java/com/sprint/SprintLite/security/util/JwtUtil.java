package com.sprint.SprintLite.security.util;
...
//        String ttlTime = env.getProperty("cache.companies.ttl-minutes", "5");
        ...
        var fetchedUser = (Users) authentication.getPrincipal();
        ...
        jwtToken = Jwts.builder().issuer(jwtIssuer).subject(jwtSubject)
                ...
                .expiration(new java.util.Date((new java.util.Date()).getTime() + (long) expirationHours * 60 * 60 * 1000))
